              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${newUser.isSystemUser
                ...
                <div className="flex gap-3 mt-6">
                  <button
                    ...
                    className={`flex-1 py-2 px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 ${isCreatingUser || !newUser.username || !newUser.fullName || !newUser.password || (!newUser.isSystemUser && !newUser.companyId)
